...
# ВНИМАНИЕ: список «не включено» взят из авторского описания тура, где
# авиабилеты идут отдельной оплатой. Цены заездов в ведомости, похоже,
# перелёт уже включают — расхождение отмечено в TODO.md, ждёт оператора.
TOUR_CONTENT = {
    "KARADENIZ": {
        "included": [
