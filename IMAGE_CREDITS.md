...
The destination-card photographs were cropped, resized, and converted to WebP
...
- `card-rize-tea.webp` — Wikimol, “Rize Tea Plantation 2005-jk”, Wikimedia Commons, CC BY-SA.
- `card-trabzon-uzungol.webp` — Ozbakanelwan, “Uzungöl, Trabzon”, Wikimedia Commons, CC BY-SA 4.0.
- `card-medina-green-dome.webp` — Adli Wahid, “Masjid An-Nabawi in Madinah”, Wikimedia Commons.
- `card-medina-nabawi.webp` — Konevi, “Al-Masjid An-Nabawi (Bird's Eye View)”, Wikimedia Commons.
- `card-jeddah-waterfront.webp` — SUAAD, “Jeddah waterfront sunset”, Wikimedia Commons, CC BY-SA 4.0.
- `card-jeddah-balad.webp` — Francisco Anzola, “Old Jeddah (Al Balad) architecture 3 Feb 2022”, Wikimedia Commons, CC BY 2.0.

Source pages and current license details are available on Wikimedia Commons
under the corresponding titles above.
