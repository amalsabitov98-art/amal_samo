...
INSERT INTO agencies (login, password_hash, password_salt, name, role) VALUES ('umida', '6d64042cea8452bb94e90f898451282c25efb7e447b8464ffb1f61ed260aa281', '6eb36d90c67c954774de001b722c9051', 'UMIDA', 'agency');
INSERT INTO agencies (login, password_hash, password_salt, name, role) VALUES ('easytourism', 'd81577379d6356a438c7288957116705016cdeae232dbd8412a372da5a7a89fa', 'c385f02d26e99b711d79c6feb33d1fd3', 'EASY TOURISM', 'agency');
INSERT INTO agencies (login, password_hash, password_salt, name, role) VALUES ('ofotour', '1136ebb439d35fc2045520ec36f32a2b904aca6bd028192ba6be40b5ed97abe1', '18034401984197164261195de56f8b62', 'OFO TOUR', 'agency');
INSERT INTO agencies (login, password_hash, password_salt, name, role) VALUES ('operator', '767860b676447269cf8d63f7ead95f2c99f0668b679eb01286aec772f3eeb6fc', '18d0aa5858bf2673d59b902459924174', 'Etihad (оператор)', 'operator');
...
INSERT INTO tours (code, name, destination, agency_commission, operator_commission, is_bookable, note, description, nights, from_price) VALUES ('KARADENIZ', 'Батуми - Ризе - Трабзон', 'Турция', 0, 0, 1, 'Еженедельные заезды, цены по типу размещения', 'Комбинированный групповой тур по Чёрному морю: Батуми, Ризе и Трабзон за 8 дней. Сопровождение узбекского гида, более 15 экскурсий, отели на первой береговой линии, трансферы на микроавтобусах Sprinter и ужин в грузинской семье.', 7, NULL);
INSERT INTO tours (code, name, destination, agency_commission, operator_commission, is_bookable, note, description, nights, from_price) VALUES ('UMRA_TAJ13', 'Умра · TAJ-13', 'Умра', 0, 0, 1, 'Август—сентябрь еженедельно; осенние заезды (октябрь—декабрь) уточняются у оператора.', 'Умра по программе TAJ-13 (13 дней / 12 ночей). Ташкент → Джидда → Мекка → Медина → Ташкент. Джидда · Hawada Hotel Jeddah · 1 ночь; Мекка · Taj Park · 990 м до Харама · 8 ночей; Медина · Grand Al Shahba · 250 м до мечети Пророка · 3 ночи.', 12, 1200);
INSERT INTO tours (code, name, destination, agency_commission, operator_commission, is_bookable, note, description, nights, from_price) VALUES ('UMRA_TAJ13P', 'Умра · TAJ-13+', 'Умра', 0, 0, 1, 'Июль—август по указанным датам.', 'Умра по программе TAJ-13+ (13 дней / 12 ночей). Ташкент → Джидда → Мекка → Медина → Ташкент. Джидда · Hawada Hotel Jeddah · 1 ночь; Мекка · Taj Park · 990 м до Харама · 8 ночей; Медина · Mukhtara Plaza · 250 м до мечети Пророка · 3 ночи.', 12, 1250);
INSERT INTO tours (code, name, destination, agency_commission, operator_commission, is_bookable, note, description, nights, from_price) VALUES ('UMRA_ANJUM13', 'Умра · ANJUM-13', 'Умра', 0, 0, 1, 'Август по указанным датам.', 'Умра по программе ANJUM-13 (13 дней / 12 ночей). Ташкент → Джидда → Мекка → Медина → Ташкент. Джидда · Hawada Hotel Jeddah · 1 ночь; Мекка · Anjum · 250 м до Харама · 8 ночей; Медина · Waqf Al Safi · 50 м до мечети Пророка · 3 ночи.', 12, 1600);
...
INSERT INTO tours (code, name, destination, agency_commission, operator_commission, is_bookable, note, description, nights, from_price) VALUES ('UMRA_JUMEIRAH13', 'Умра · JUMEIRAH-13', 'Умра', 0, 0, 1, 'Август по указанным датам.', 'Умра по программе JUMEIRAH-13 (13 дней / 12 ночей). Ташкент → Джидда → Мекка → Медина → Ташкент. Джидда · Hawada Hotel Jeddah · 1 ночь; Мекка · Jumeirah Hotel · 100 м до Харама · 8 ночей; Медина · Waqf Al Safi · 50 м до мечети Пророка · 3 ночи.', 12, 1900);
INSERT INTO tours (code, name, destination, agency_commission, operator_commission, is_bookable, note, description, nights, from_price) VALUES ('UMRA_SAJA10', 'Умра · SAJA-10', 'Умра', 0, 0, 1, 'Июль—сентябрь еженедельно; осенние заезды (октябрь—декабрь) уточняются у оператора.', 'Умра по программе SAJA-10 (10 дней / 9 ночей). Ташкент → Медина → Мекка → Джидда → Ташкент. Медина · Saja Al-Madinah · 250 м до мечети Пророка · 4 ночи; Мекка · Taj Park · 990 м до Харама · 5 ночей.', 9, 1250);
INSERT INTO tours (code, name, destination, agency_commission, operator_commission, is_bookable, note, description, nights, from_price) VALUES ('UMRA_SWISS10', 'Умра · SWISSOTEL-10', 'Умра', 0, 0, 1, 'Еженедельно с 6 августа по 3 декабря — точные даты уточняются у оператора.', 'Умра по программе SWISSOTEL-10 (10 дней / 9 ночей). Ташкент → Медина → Мекка → Джидда → Ташкент. Медина · Waqf Al Safi · 50 м до мечети Пророка · 4 ночи; Мекка · Swissotel Makkah · 50 м до Харама · 5 ночей.', 9, 1650);
...
INSERT INTO tours (code, name, destination, agency_commission, operator_commission, is_bookable, note, description, nights, from_price) VALUES ('UMRA_JUMEIRAH10', 'Умра · JUMEIRAH-10', 'Умра', 0, 0, 1, 'Еженедельно с 6 августа по 3 декабря — точные даты уточняются у оператора.', 'Умра по программе JUMEIRAH-10 (10 дней / 9 ночей). Ташкент → Медина → Мекка → Джидда → Ташкент. Медина · Waqf Al Safi · 50 м до мечети Пророка · 4 ночи; Мекка · Jumeirah Jabal Omar · 100 м до Харама · 5 ночей.', 9, 1750);
