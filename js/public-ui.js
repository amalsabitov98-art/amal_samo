...
(function (global) {
  ...
  var dictionaries = {
    ru: {
      ...
      "upcoming.text": "Даты, аэропорт и цена — всё, что нужно, чтобы выбрать.",
    ...
    uz: {
      ...
      "upcoming.text": "Sana, aeroport va narx — tanlash uchun kerakli hammasi.",
    ...
    en: {
      ...
      "upcoming.text": "Dates, airport and price — everything you need to choose.",
    ...
    tr: {
      ...
      "upcoming.text": "Tarih, havalimanı ve fiyat — seçim için gereken her şey.",
