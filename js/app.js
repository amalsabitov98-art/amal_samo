(function () {
  ...
  function voucherCss() {
    return (
      ...
      ".leg{display:flex;align-items:center;position:relative}" +
      ".leg .card{flex:1;text-align:center;padding:7px 10px}" +
      ".leg .card:first-child{border-right:0;border-radius:9px 0 0 9px}" +
      ".leg .card:last-child{border-left:0;border-radius:0 9px 9px 0}" +
      ...
      ".req .val{font-size:12.5px;text-transform:uppercase;font-weight:700}" +
