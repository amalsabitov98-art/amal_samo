...
(function (global) {
   ...
   *
   * Telegram указан только у Аскара — это подтверждённая ссылка. Для Ойбека
   * дали телефон и ничего больше, а t.me/+номер сработает лишь если у него
   * есть Telegram на этом номере; проверить мы не можем, поэтому не пишем. */
  var MANAGERS = [
    {
      name: "Аскар",
